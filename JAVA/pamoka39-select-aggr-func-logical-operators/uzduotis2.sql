...
INSERT INTO filmas(id,pavadinimas, zanras,studija,ziurovu_ivertinimas,pelningumas,ekspertu_ivertinimas,pajamos,isleidimo_metai) VALUES
...
,(14,'The Ugly Truth','Comedy','Independent',68,5.402631579,14,205.3,2009)
...
,(17,'The Proposal','Comedy','Disney',74,7.8675,43,314.7,2009)
,(18,'The Invention of Lying','Comedy','Warner Bros.',47,1.751351351,56,32.4,2009)
...
,(36,'Not Easily Broken','Drama','Independent',66,2.14,34,10.7,2009)
,(37,'No Reservations','Comedy','Warner Bros.',64,3.307180357,39,92.6,2007)
...
,(41,'Music and Lyrics','Romance','Warner Bros.',70,3.64741055,63,145.9,2007)
...
,(56,'Killers','Action','Lionsgate',45,1.245333333,11,93.4,2010)
,(57,'Just Wright','Comedy','Fox',58,1.797416667,45,21.57,2010)
,(58,'Jane Eyre','Romance','Universal',77,0,85,30.15,2011)
,(59,'It''s Complicated','Comedy','Universal',63,2.642352941,56,224.6,2009)
,(60,'I Love You Phillip Morris','Comedy','Independent',57,1.34,71,20.1,2010)
...
SELECT * FROM filmas WHERE 1;

SELECT * FROM filmas WHERE studija = 'warner bros.';

SELECT * FROM filmas WHERE pelningumas > 1;

SELECT * FROM filmas WHERE pajamos > 100 AND pajamos < 300;

SELECT * FROM filmas WHERE ziurovu_ivertinimas > 80 AND ekspertu_ivertinimas < 60;

SELECT * FROM filmas WHERE zanras = 'comedy' AND isleidimo_metai = '2010';

SELECT * FROM filmas ORDER BY pavadinimas;

SELECT * FROM filmas ORDER BY isleidimo_metai DESC, ekspertu_ivertinimas DESC;

SELECT SUM(pajamos) FROM filmas;

SELECT AVG(pelningumas) FROM filmas;

SELECT * FROM filmas order by ziurovu_ivertinimas DESC limit 5;

SELECT * FROM filmas where isleidimo_metai = '2010' order by pelningumas DESC limit 1 ;

SELECT * FROM filmas order by (ziurovu_ivertinimas - ekspertu_ivertinimas) DESC;